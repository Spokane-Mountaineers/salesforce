...
Implementation plans for in-progress and completed work. Each plan captures the
problem, the approach, and the steps to carry it out.

- [Fix Event Participant Contact/User Mapping](2026-03-18-fix-event-participant-contact-user-mapping.md)
